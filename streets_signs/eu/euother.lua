local euother = {
	...
	{ "arrowquartercircle", "Quarter Circle", { white = 2, black = 1 } },
	{ "arrowsemicircle", "Semicircle", { white = 2, black = 1 } },
	{ "arrowthreequartercircle", "Three-Quarter Circle", { white = 2, black = 1 } },
